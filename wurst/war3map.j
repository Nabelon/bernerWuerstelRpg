...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'n00E', 5165.8, 107.8, 233.708)
    set u=CreateUnit(p, 'n001', 2080.0, - 216.3, 185.213)
    set u=CreateUnit(p, 'n001', 2826.9, - 2328.8, 99.166)
    set u=CreateUnit(p, 'n001', 2333.0, - 2326.2, 143.280)
    ...
    set u=CreateUnit(p, 'n00E', 3325.9, - 4362.4, 301.859)
    set u=CreateUnit(p, 'n007', 3324.7, - 595.5, 268.217)
    set u=CreateUnit(p, 'n007', 3068.0, - 778.5, 146.178)
    set u=CreateUnit(p, 'n00E', 5263.0, - 3754.2, 141.607)
    ...
    set u=CreateUnit(p, 'n00E', 6854.4, - 905.2, 186.378)
    set u=CreateUnit(p, 'n00E', 4321.5, - 1629.9, 19.919)
    set u=CreateUnit(p, 'n00E', 8419.9, - 1443.9, 177.479)
    set u=CreateUnit(p, 'n00E', 8507.3, - 1212.5, 118.689)
    ...
    set u=CreateUnit(p, 'n00E', 8208.6, - 2.2, 336.950)
    set u=CreateUnit(p, 'n009', 7478.7, 2683.1, 349.870)
    set u=CreateUnit(p, 'n009', 6990.7, - 952.0, 154.846)
    set u=CreateUnit(p, 'n009', 6931.6, - 675.1, 66.700)
    set u=CreateUnit(p, 'n009', 7568.8, 1563.5, 2.692)
    set u=CreateUnit(p, 'n009', 6711.9, 903.3, 284.632)
    set u=CreateUnit(p, 'n009', 7994.7, - 59.3, 180.302)
    ...
    set u=CreateUnit(p, 'n00F', 8774.0, 1028.4, 273.063)
    set u=CreateUnit(p, 'n00F', 8857.9, 1111.5, 127.841)
    set u=CreateUnit(p, 'n00F', 9521.9, 2818.4, 278.413)
    set u=CreateUnit(p, 'n00F', 9656.6, 2818.4, 70.425)
    set u=CreateUnit(p, 'n00F', 9597.9, 2686.4, 359.824)
    set u=CreateUnit(p, 'n00F', 10908.9, 4897.2, 13.074)
    set u=CreateUnit(p, 'n00F', 11038.0, 4897.2, 130.324)
    set u=CreateUnit(p, 'n00F', 10896.1, 4739.7, 294.904)
    set u=CreateUnit(p, 'n00F', 11000.1, 4747.2, 347.398)
    set u=CreateUnit(p, 'n00F', 11043.8, 5919.3, 291.081)
    set u=CreateUnit(p, 'n00F', 10789.7, 3519.5, 83.784)
    set u=CreateUnit(p, 'n00F', 9408.6, - 985.6, 183.126)
    set u=CreateUnit(p, 'n00F', 9645.7, 207.8, 88.080)
    set u=CreateUnit(p, 'n00F', 9776.3, 202.8, 286.873)
    set u=CreateUnit(p, 'n00F', 9762.3, 386.9, 11.481)
    set u=CreateUnit(p, 'n00F', 10599.5, 1025.9, 307.714)
endfunction
