...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'n00H', 1081.7, - 4112.7, 93.409)
    set u=CreateUnit(p, 'n00H', 1187.7, - 3867.5, 280.918)
    set u=CreateUnit(p, 'n00H', 1068.1, - 3796.5, 330.435)
    set u=CreateUnit(p, 'n00H', 907.7, - 4000.8, 321.843)
    set u=CreateUnit(p, 'n00H', 1148.8, - 3418.2, 34.971)
endfunction
...
function CreateUnitsForPlayer11 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'n00H', 12041.5, 6410.4, 346.322)
    set u=CreateUnit(p, 'n00H', 13324.3, 1679.4, 38.596)
    set u=CreateUnit(p, 'n00H', 19101.7, 104.1, 150.089)
    set u=CreateUnit(p, 'n00H', 19229.2, 248.2, 215.701)
    set u=CreateUnit(p, 'n00H', 20090.4, 2352.6, 244.332)
...
function InitTrig_WB1_Donnerschlag takes nothing returns nothing
    ...
    call TriggerRegisterUnitLifeEvent(gg_trg_WB1_Donnerschlag, gg_unit_N00D_0112, LESS_THAN, 50)
